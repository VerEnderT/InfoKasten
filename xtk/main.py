...
class Fenster(QWidget):
    ...
    # Testprogramm starter
    def sound(self):
        cmd = "pkill -9 -f soundtest.py"
        os.system(cmd)
        cmd = "python3 /usr/share/xtk/soundtest.py"
        subprocess.Popen(cmd.split(" "), shell=False)
        self.radioKeys3.setEnabled(True)
        self.radioKeys4.setEnabled(True)
        self.radioKeys3.setStyleSheet(self.sstestradioaktiv)
        self.radioKeys4.setStyleSheet(self.sstestradioaktiv)
    def mic(self):
        cmd = "pkill -9 -f mictest.py"
        os.system(cmd)
        cmd = "python3 /usr/share/xtk/mictest.py"
        subprocess.Popen(cmd.split(" "), shell=False)
        self.radioKeys7.setEnabled(True)
        self.radioKeys8.setEnabled(True)
        self.radioKeys7.setStyleSheet(self.sstestradioaktiv)
        self.radioKeys8.setStyleSheet(self.sstestradioaktiv)
    def tastaturtest(self):
        cmd = "pkill -9 -f tastaturtest.py"
        os.system(cmd)
        cmd = "python3 /usr/share/xtk/tastaturtest.py".split(" ")
        subprocess.Popen(cmd, shell=False)
        self.radioKeys1.setEnabled(True)
        self.radioKeys2.setEnabled(True)
        self.radioKeys1.setStyleSheet(self.sstestradioaktiv)
        self.radioKeys2.setStyleSheet(self.sstestradioaktiv)
    def cam(self):
        cmd = "pkill -9 -f cam.py"
        os.system(cmd)
        cmd = "python3 /usr/share/xtk/cam.py".split(" ")
        subprocess.Popen(cmd, shell=False)
        self.radioKeys9.setEnabled(True)
        self.radioKeysA.setEnabled(True)
        self.radioKeysB.setEnabled(True)
        self.radioKeys9.setStyleSheet(self.sstestradioaktiv)
        self.radioKeysA.setStyleSheet(self.sstestradioaktiv)
        self.radioKeysB.setStyleSheet(self.sstestradioaktiv)
    def displaytest(self):
        cmd = "python3 /usr/share/xtk/displaytest.py".split(" ")
        subprocess.Popen(cmd, shell=False)
        self.radioKeys5.setEnabled(True)
        self.radioKeys6.setEnabled(True)
        self.radioKeys5.setStyleSheet(self.sstestradioaktiv)
        self.radioKeys6.setStyleSheet(self.sstestradioaktiv)
    def beenden(self):
        cmd = "python3 /usr/share/xtk/beenden.py".split(" ")
        subprocess.Popen(cmd, shell=False)
    ...
    def initMe(self):
        ...
        cmd ='xfconf-query -c xfce4-desktop -p /desktop-icons/style -s 0'
        os.system(cmd)


        self.passwd = "user"
        self.path = "/freigabe/"
        self.toolname = "X-TestKasten 22.11"
        ...
        # vvbox3
        vvboxlayout3 = QVBoxLayout()
        self.labelTests = QLabel("Tests")
        self.labelTests.setStyleSheet(ss1)
        vvboxlayout3.addWidget(self.labelTests)

        # tastaturtest
        self.btnTestKeys = QPushButton("Tastaturtest")
        self.btnTestKeys.clicked.connect(self.tastaturtest)
        self.btnTestKeys.setStyleSheet(sstestbtn)
        vvboxlayout3.addWidget(self.btnTestKeys)
        self.radioKeys1 = QRadioButton("BESTANDEN")
        self.radioKeys1.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeys1)
        self.radioKeys2 = QRadioButton("NICHT BESTANDEN")
        self.radioKeys2.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeys2)
        self.bg1 = QButtonGroup(self)
        self.bg1.addButton(self.radioKeys1)
        self.bg1.addButton(self.radioKeys2)
        self.radioKeys1.setEnabled(False)
        self.radioKeys2.setEnabled(False)
        self.radioKeys2.setChecked(True)

        # soundtest 
        self.btnTestSound = QPushButton("Soundtest")
        self.btnTestSound.clicked.connect(self.sound)
        self.btnTestSound.setStyleSheet(sstestbtn)
        vvboxlayout3.addWidget(self.btnTestSound)
        self.radioKeys3 = QRadioButton("BESTANDEN")
        self.radioKeys3.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeys3)
        self.radioKeys4 = QRadioButton("NICHT BESTANDEN")
        self.radioKeys4.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeys4)
        self.bg2 = QButtonGroup(self)
        self.bg2.addButton(self.radioKeys3)
        self.bg2.addButton(self.radioKeys4)
        self.radioKeys3.setEnabled(False)
        self.radioKeys4.setEnabled(False)
        self.radioKeys4.setChecked(True)

        # Bildschirmtest 
        self.btnTestDisplay = QPushButton("Bildschirmtest")
        self.btnTestDisplay.clicked.connect(self.displaytest)
        self.btnTestDisplay.setStyleSheet(sstestbtn)
        vvboxlayout3.addWidget(self.btnTestDisplay)
        self.radioKeys5 = QRadioButton("BESTANDEN")
        self.radioKeys5.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeys5)
        self.radioKeys6 = QRadioButton("NICHT BESTANDEN")
        self.radioKeys6.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeys6)
        self.bg3 = QButtonGroup(self)
        self.bg3.addButton(self.radioKeys5)
        self.bg3.addButton(self.radioKeys6)
        self.radioKeys5.setEnabled(False)
        self.radioKeys6.setEnabled(False)
        self.radioKeys6.setChecked(True)

        # Microfontest 
        self.btnTestMic = QPushButton("Mikrofontest")
        self.btnTestMic.clicked.connect(self.mic)
        self.btnTestMic.setStyleSheet(sstestbtn)
        vvboxlayout3.addWidget(self.btnTestMic)
        self.radioKeys7 = QRadioButton("BESTANDEN")
        self.radioKeys7.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeys7)
        self.radioKeys8 = QRadioButton("NICHT BESTANDEN")
        self.radioKeys8.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeys8)
        self.bg4 = QButtonGroup(self)
        self.bg4.addButton(self.radioKeys7)
        self.bg4.addButton(self.radioKeys8)
        self.radioKeys7.setEnabled(False)
        self.radioKeys8.setEnabled(False)
        self.radioKeys8.setChecked(True)

        # Kameratest 
        self.btnTestCam = QPushButton("Kameratest")
        self.btnTestCam.clicked.connect(self.cam)
        self.btnTestCam.setStyleSheet(sstestbtn)
        vvboxlayout3.addWidget(self.btnTestCam)
        self.radioKeys9 = QRadioButton("BESTANDEN")
        self.radioKeys9.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeys9)
        self.radioKeysA = QRadioButton("NICHT BESTANDEN")
        self.radioKeysA.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeysA)
        self.radioKeysB = QRadioButton("NICHT VORHANDEN")
        self.radioKeysB.setStyleSheet(sstestradio)
        vvboxlayout3.addWidget(self.radioKeysB)
        self.bg5 = QButtonGroup(self)
        self.bg5.addButton(self.radioKeys7)
        self.bg5.addButton(self.radioKeys8)
        self.radioKeys9.setEnabled(False)
        self.radioKeysA.setEnabled(False)
        self.radioKeysA.setChecked(True)
        self.radioKeysB.setEnabled(False)

        # Herunterfahren 
        self.btnTestEnd = QPushButton("Herunterfahren")
        self.btnTestEnd.clicked.connect(self.beenden)
        self.btnTestEnd.setStyleSheet(sstestbtn)
        vvboxlayout3.addWidget(self.btnTestEnd)



        #vvhboxlayout3 = QHBoxLayout()
        vvboxlayout3.addStretch()
        ...
        hhboxlayout.addLayout(vvboxlayout3)
        ...
        self.setGeometry(int(x), 10, breite, 30)
        self.setWindowTitle("System-Informationen")
        self.setWindowIcon(QIcon("/usr/share/xtk/images/logo.png"))
        self.setStyleSheet(
        ...
        if os.path.isfile('/usr/share/xtk/atk'):
            vvvboxlayout.addWidget(self.saveBtn)
            dateiname = '/usr/share/xtk/atk'
